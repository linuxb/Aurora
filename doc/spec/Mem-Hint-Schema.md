...
- Security scope is written by Flory into `Mem3SearchRequest.scope` from trusted Task metadata, and LLM overrides must not be accepted.
...
3. trusted `Mem3SearchRequest.scope` (injected by Flory, not generated by LLM)
